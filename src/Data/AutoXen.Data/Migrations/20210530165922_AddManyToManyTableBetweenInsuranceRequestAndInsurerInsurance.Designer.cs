...
namespace AutoXen.Data.Migrations
{
    ...
    [Migration("20210530165922_AddManyToManyTableBetweenInsuranceRequestAndInsurerInsurance")]
    partial class AddManyToManyTableBetweenInsuranceRequestAndInsurerInsurance
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AutoXen.Data.Models.Insurance.InsuranceRequestInsurerInsurance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("InsurerInsuranceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("InsurerInsuranceId");

                    b.ToTable("InsuranceRequestsInsurerInsurances");
                });
            ...
            modelBuilder.Entity("AutoXen.Data.Models.Insurance.InsuranceRequestInsurerInsurance", b =>
                {
                    b.HasOne("AutoXen.Data.Models.Insurance.InsuranceRequest", "InsuranceRequest")
                        .WithMany("InsuranceRequestsInsurerInsurances")
                        .HasForeignKey("InsuranceRequestId");

                    b.HasOne("AutoXen.Data.Models.Insurance.InsurerInsurance", "InsurerInsurance")
                        .WithMany()
                        .HasForeignKey("InsurerInsuranceId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("InsuranceRequest");

                    b.Navigation("InsurerInsurance");
                });
            ...
            modelBuilder.Entity("AutoXen.Data.Models.Insurance.InsuranceRequest", b =>
                {
                    b.Navigation("InsuranceRequestsInsurerInsurances");
                });
